		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				for(int i = 0; i<RepositorioCarrinho.car.size(); i++) {//Passando a lista carrinho para um lista auxiliar
					AtualizarLista m1 = new AtualizarLista (RepositorioAtualizarLista.att.size()-1,RepositorioCarrinho.car.get(i).getNome(),RepositorioCarrinho.car.get(i).getQuantidade(),RepositorioCarrinho.car.get(i).getPreco(),RepositorioCarrinho.car.get(i).getPromo());
				...
				for(int i = 0; i<RepositorioAtualizarLista.att.size(); i++) {
					Carrinho m1 = new Carrinho (RepositorioCarrinho.car.size(),RepositorioAtualizarLista.att.get(i).getNome(),RepositorioAtualizarLista.att.get(i).getQuantidade(),RepositorioAtualizarLista.att.get(i).getPreco(),RepositorioAtualizarLista.att.get(i).getPromo());
